**Office Hours with Kevin & Qasar at Startup School SV
...
[00：00：02]好的。我叫凯文·黑尔。我的名字是Casser Eunice，我们是Y Combinator的合伙人，这意味着，不管是否社交，Batch都在努力招募尽可能多的创始人，并与他们交谈。此外，我们阅读了大量的应用程序，当它们通过批处理时，它们与创业公司一起工作，然后帮助校友。我们所做的大部分是做大量的办公时间，这就是我们今天在这里要做的。
...
[00：00：29]有四种不同类型的办公时间，我们做的第一种是小组办公时间。我们把分批分成几个子组，一次遇到两个合伙人，大约有五六家初创公司，这些初创公司把它描述为每周一次的会议。他们描述了公司里发生的事情。作为一名创始人，当你看到公司的发展速度时，团队管理人员会很好地帮助你理解，同时也会发现，你作为一家初创公司所遇到的问题，在不同类型的公司之间实际上是非常相似的。第二种类型的OFSAA，我们将在这里尝试模仿个别的办公时间，当你听说办公室这个术语是巨大的多年时间的时候。这就是我们所说的第三类OFSAA公司办公时间。我们会有苹果(Apple)、安卓(Android)等人进入Rackspace成为美国公司，来帮助公司解决技术问题。最后一个是我们的投资者办公时间。所以像塞科亚·安德烈森等人。他们会过来和公司谈话，就在Demo日期之前，他们准备好了筹款和演示日。因此，话虽如此，我认为关于OFSAA还有一些其他的事情值得注意，以及如何有效地做到这一点。
...
[00：01：44]显然，第一件事是，我们在舞台上要做的不是正常的办公时间，所以我们和每个公司只有10分钟的时间。通常情况下，我们不会在房间里有50，100人这样做。然后我认为另一件事是我们通常和公司有很多联系。所以我们已经阅读了他们的申请。我们抓到他们几次了。通常情况下，我们会深入探讨一个问题。这将是更多的战术使用，我们不会在这里这样做。我们所说的，所有这些公司之后，我们将去与他们更深入的交谈。
...
[00：02：17]我们将尽量避免制造类似音高和反应的场景，以及更长的时间。问：你面临的问题是什么，然后尝试对它们进行剖析，希望从中得到一些价值。
...
[00：02：28]另一件事是，我们试图让每个人都明白，在军官中，我们的工作不是告诉你该怎么做。很多人来问我们，你会做些什么？很多时候，我们肯定会告诉你我们的观点，但我通常会告诉很多初创公司，你正在努力想出自己的启发，这样你最终就能管理好公司，你就不需要再回到我们这里来了。我认为我们喜欢告诉人们的是，你需要开始赚取你自己的股权。最后，随着时间的推移，当我们有办公时间的时候，我们喜欢做两件事，以使它们尽可能高效。首先，我们喜欢知道自己号码正确的公司。你今天会看到一点这个。我们会问很多问题，比如潜入公司，试图弄清楚。好的。这就是你所处的位置，然后开始有一种感觉，这就是你需要做的事情，你的衡量标准是你公司的心跳。

\[00:03:17\] It\'s always I think off putting if you don\'t know very
...
[00：03：25]最后一件事是，我们总是希望你带着你想要解决的具体问题来找我们。所以，如果你来找我们，你只是想拍点屎，或者像我这样追上东西，因为这样对我们和你来说都是浪费时间的，效率很低的。因为最终你应该像在你的商店里工作，做任何我们希望你关注的成长数字或KPI。还有一个明确的迹象表明，如果你和我们一起有多个办公时间，如果你在重复你的话，我们会很担心，所以如果我们谈论一些事情，而我在两周后再和你交谈，似乎我们有着完全相同的故事或说法。右（边），正确的这对你来说不是个好兆头。做得最好的公司通常是喜欢我们所说的一切的公司，他们去尝试，而另一家回来对我说，看，这才是起作用的东西，或者说，凯文，像这样的东西，完全没有用。这就是为什么。然后我们尝试了其他的方法。
...
[00：04：40]我是艾琳·谢尔曼·威廉·韦伯，我知道这是一项开源的服务。因此，我们帮助应用程序轻松地连接到后台和服务器，我们处理诸如用户注册和管理、数据存储和查询等事务。我们刚刚在周一推出了一个私有的公开测试版，到目前为止，我们只需要在6岁的时候就能忍受它，所以我们只想把它推广到Android设备上。到目前为止一切都很顺利。
...
[00：05：24]没错。好的。好的从那里开始。比如你们和DPA有什么相似之处或不同之处。
...
[00：05：44]我们所做的事情的主要原因或主要要点之一是分家，它完全是可扩展的。所以它是开源的。因此，作为一个开发人员，他们使用它。我们试图提供他们所需要的所有基本API，但是如果他们需要做任何扩展或基于的事情，他们会给我一些非常具体的东西。它仍然像从来没有说过，你有一个用户发送数据，无论出于什么原因，你想要进行事件的基础上，或者如果你想像另一个网站从你的Web服务器查询\没有给你一个真正好的方式去做这件事。
...
[00：06：22]所以在一年半以前，他们发布了云代码，基本上你可以创建javascript函数，你可以定制和做一些事情。所以每一次你点击其中的一个，它就算作一个API和一个API，然后你从那里开始，所以我想弄清楚，就像你们现在有用户一样，一些人正在尝试并使用它。
...
[00：06：45]所以我们不知道到底有多少个，因为它是开源的，我们周一刚启动，那么你要服务多少个请求呢？
...
[00：07：08]所以我们将尝试做红色帽子蒙戈DBE模式的一种DO咨询服务。
...
[00：07：27]从字面上讲，这不是一个好的商业模式。这是一种手工艺。我们会帮你弄清楚该做什么是很好的。
...
[00：07：36]我的意思是，从我们的研究来看，我们认为公司会支付支持，就像他们希望能够选择拿起电话一样，他们现在正在为SAPOL付费吗？弗雷戈斯不是我们的。
...
\[00:07:57\] Yeah. So we do we do provide like free support because
right now we\'re just trying to build the community.

[00：07：57]是的。所以我们确实提供了免费的支持，因为我们现在只是在努力建设社区。
...
[00：08：01]是的。所以我认为这是第一件事。我认为任何类似的事情，特别是当我们试图建立平台，让人们对你感到兴奋的时候，只需要让人们喜欢注册和成长。你得弄清楚你要怎么发现这个。但你最大的事情是，我不会为这种增长设置任何障碍，而且我也会像网站一样开放，这将帮助任何人现在做这件事，特别是因为你们这些家伙，这个东西现在正处于测试阶段。右（边），正确的是的，因为它像巴达一样。
...
[00：08：27]所以它有点安静的原因。是的。我们想要等到我们有一个IWK的时候，我真的很想推动秋季发射。但我的意思是，现在我们还好。
...
[00：08：40]对。所以，作为一个人，我最不想看到的东西就是一个表面，我要在数据的基础上构建我的应用程序。右（边），正确的因此，这将以许多不同的方式限制经济增长。所以有很多不同的东西喜欢你。我认为你应该放弃，因为无论如何你都在寻求成长。然后，一旦你有了一个足够大的社区，你就可以开始说，哦，会有一些人愿意为敬业的专家付费。我的意思是说，那肯定是一场彻头彻尾的赌博。
...
[00：09：11]我指的是一家公司的一般机制，或者你需要钱来支持你的公司，然后你需要从任何生态系统中提取价值，或者从生态系统中榨取资金，这将需要你们有一个致力于分裂的大社区，然后是那些愿意支付给我他们的小公司或大公司的机构或人。这非常可怕，因为除了RedHatMungo之外，这可能需要很长时间才能找到任何其他的选择。
...
[00：09：52]所以我们已经很接近时间了。嗯到此为止吧。就像你最重要的事情是，不管发生什么，你都必须建立一个社区，这就像我作为一个投资者要寻找这样的东西的最大证据。右（边），正确的就像了解了有多少人在使用它，而你在谈论的是那些尝试使用它的用户的术语。有没有人要你们帮忙。是那么人们现在是如何使用它的呢？
...
[00：10：17]据我们所知。就像我说的，我们周一刚刚发布了一个Reddit帖子，我看到了。所以我们就像我们有12人一样。因此，我们有12个人是测试的一部分，我们要求他们提供所有反馈。所以我们已经得到了关于我们的许可的反馈，我们已经改变了这一点，因为我们使用了GPS，而我们忽略了这一点。当您使用GPL库时，您应该打开所有的源代码。所以我们改变了许可证。我们在我们的网站上得到了反馈。

\[00:10:43\] That\'s good. I mean that\'s that. That is like that is
...
[00：10：43]那很好。我是说\就是这样。这就是正确的态度，我的意思是，当你建立一个早期公司的时候，你有点像在这个黑暗的洞穴里，每个反馈-不管是结构化的，非结构化的，你可以从你那里得到的-就像你应该去的论坛里一样，而不仅仅是长时间运行它。所以我认为这是一个很好的开始，但这肯定是一个可靠的开始。
...
[00：11：42]下一家公司是首席运营官，如果你忘了它在他们的衬衫上，谁会拥有它。同样，你们能自我介绍一下吗，然后你们会做什么。是的，我是主席，我们来自墨西哥蒙特雷。我也是一样的人。
...
[00：12：05]所以我们做的是一个角落，它是一个移动应用程序，它是用来建立你的购物清单的。我们要做的是，我们会留下比你说的更具体的价格、交易和产品位置的虚拟信息。

\[00:12:18\] It\'s a mobile app for building your shopping list. So when
I open it up do you see what I see.

[00：12：18]它是一个移动应用程序，用来建立你的购物清单。所以当我打开它时，你会看到我看到的东西。
...
[00：12：34]区别在于，我们掌握了商店内商品的价格、地点和交易的所有信息。所以它实际上就像几乎所有的常规购物清单一样，你聪明，是的。所以我们帮助人们节省时间和金钱时，杂货店。
...
[00：12：54]你从哪里得知，我看到的最糟糕的事情是我看到了你的故事，但我的意思是，如果你进了另一家商店，你就会自动转到你在购物清单上看到的商店。好的，就像基于地点的商店一样。是的，是基于地点的。马上他们就会给你展示基于地点的交易。
...
[00：13：11]所以我必须先下载应用程序，然后发布信息。你们在哪里只是为了把你们正在做的事剥离掉。我们已经得到了所有的库存和定价信息。

\[00:13:21\] So we are depending on the retailer like we have some
...
[00：13：21]所以我们依赖于零售商，就像我们和墨西哥的一些零售商达成了一些协议，因为他们在这个行业拥有权力，尽管他们想要的是他们自己喜欢的。好吧，我很喜欢，但我不想让我的竞争对手加入。所以我们通过使用机器人和更新信息来绕过这个问题。所以你在刮他们的网站。其中一些零售商-那些零售商-已经摆脱了一些擦伤眼睛的问题。
...
基本上是的，我们学到了很多。比如，第一个月，我们就像在抱怨用户，然后我们开始看到人们开始更喜欢价格和交易。我们的同伴Ghab开始稳定在更高的水平上。
...
[00：14：28]所以，我想以你为例，我先向你道歉，你说，就像你说的，我一直都知道，很多创业公司的创始人来找我，跟我说话，就好像我知道你的用户是如何增长的，你喜欢一个特定的数字，就像我们有11000用户一样。对我们来说，尤其是Y。我更感兴趣的是加速度，而不是特定的速度。右（边），正确的我是说你想知道自己是对的。现在的增长率是多少？
...
[00：15：03]所以最初我们会通过我们在墨西哥的网络来做，然后我们有很多法语11000。然后，我们开始做一些其他类型的事情，比如Facebook广告，测试哪种信息更有效，实际上我们花了一笔收购，比如，在1点到每名用户4美元之间。

\[00:15:24\] Okay. In total you spend like 10 Holling every dollar you
spent you\'re going to get up to 10 years.

[00：15：24]好的。总的来说，你花了大约10美元，每花一美元，你就会活到10年。
...
[00：15：29]好吧，对不起。他们有多投入。比如他们每隔多久就会出现一次。因此，我们的活动用户每月使用2.8次。但是活跃用户的百分比是36%。
...
[00：15：39]好的。例如，在这36%中的前20名中，前25名的用户在每个月5次以上，所以每周不止一次。
...
[00：15：48]我的一个问题是，你是否真的让任何人改变他们购买的产品，或者改变任何人的行为，因为这样的目标是正确的。如果你有什么东西显示给人们看，员工的价格是给他们看的某种东西，这最终将是推荐，大幅削减数据播放。因此，我想知道，你是否有任何证据表明，由于看了你的应用程序，你喜欢有人决定去别的地方购物或购买不同的产品。

\[00:16:08\] Yes. So goal in the end is to empower people with
information to make wise decisions when grocery shopping and save money.

[00：16：08]是的。因此，最终的目标是赋予人们信息能力，让他们在购物和省钱时做出明智的决定。
...
[00：16：18]作为一个生意人，你是如何赚钱的？是的，所以我们实际上是在从品牌中赚钱，因为就像我们最初试图从零售商那里得到的一样，他们的周期很长，而且他们有能力，但是品牌喜欢我们，因为我们允许他们在正确的时间找到合适的顾客，并利用他们的购买而不利用我们所去的商店的位置。
...
[00：16：38]我确实想回到数据问题上来，因为它是如此的关键，而且它正在增长，所以你正在刮商店。如果它们没有任何在线存在，会发生什么情况。
...
[00：16：50]不，我们没有那些商店。是的，我们只有墨西哥的沃尔玛(Wal-Mart)，所以你只能做零售商或其他商店。
...
[00：16：58]是的，这不是炒作，当你在街上的时候，有很多零售商，你实际上不是在，很多零售商只是一个。不。
...
[00：17：05]我们就像整个蒙特雷墨西哥城的五家大商店，我们实际上是从一家小商店开始的，因为我们大多数人都想买-我们发现这是不同的，很难扩大规模
...
[00：17：19]我们所有的商店都先去然后再去，你发现用户很难记住你的应用程序存在，而且你有统计数据来激活64。
...
[00：17：30]是的，事实上，每一次类似的事情，只要两个月他们没有使用，我们就发了一封电子邮件给你。你为什么不利用我们呢？
...
[00：17：40]他们一直在说：“好吧，你把我的故事带到我的店里去了，每当我们有了新的小连锁消费，就好像我不是那个在我家买杂货的人。所以这也是我们的目标。我们瞄准每个人，因为我们想看看谁会坚持。我知道。”
...
[00：17：55]是的。那么，终极客户会说你的品牌，那会怎么样呢？你是如何吸引第一批品牌的，你喜欢那些你真正的客户的品牌吗？
...
\[00:18:21\] I\'m sorry how effective is like advertising on your
platform. Yeah. So exactly.

[00：18：21]我很抱歉，在你的平台上做广告有多有效。是的，没错。

\[00:18:25\] I mean if so let\'s say I\'m timelessly in Mexico City.
What am I buying.

[00：18：25]我的意思是，如果是这样的话，让我们说我在墨西哥城是永恒的，我要买什么？
...
[00：18：30]是的。所以这基本上是两件事。一种是广告，比如有针对性的广告，另一种是分析，因为我们在头脑中给他们一个分析。就像我们还没见过的人一样，他们说，好的，这很管用。例如，这种可乐在百事可乐和我们购买的产品上都结束了。所以我们现在给出了这个，就像我们很惊讶，就像他们喜欢这样的品牌意识，信息和广告的有效性。我们还需要证明这一点。
...
[00：19：03]所以我们有几个问题。我喜欢前面的挑战。其中之一就是我们现在就把注意力集中在粘性上。我们还想让更多的病毒传播开来。这是一个问题，我们一直在改进产品，让它有更好的厨艺。
...
[00：19：21]所以当你说你想说得很清楚的时候。比如为什么。为什么你是在做你所做的事情，同时又集中注意力。是的。所以根本原因是因为这就是你的客户，品牌和东西。
...
[00：19：33]是的，像他们这样的品牌希望我们有更多的用户。我们爱死它了。好的，我们用品牌来证明概念，消除一些假设。但是现在我们的重点是与用户一起做更多的工作，以获得更好的服务。
...
[00：19：55]好的。那么，在零售商方面，你们要做些什么来从墨西哥城以外的地方成长呢？是的，如何扩展数据输入。
...
[00：20：04]所以我们有网络，就像我们说的那样，我们将继续超越他们。实际上，我们有一些新的投资者，他们在这个网络中非常好。但在那之后，我们必须成为一个市场，你为什么需要这样做。
...
[00：20：23]这就是为什么现在为了连接我们两个试验。右（边），正确的在那之后，为了成长，你必须成为一个市场，在那里，品牌可以在没有我们的情况下做广告，就像现在一样，我们是有意的，我们正在学习他们的品牌是什么。
...
[00：20：42]是的。是的，我明白。但事情是，你没有建立一个市场的地方增长，你必须做的是像增长所有用户的东西，然后你建立市场，使它更有效率。对。所以，就像我唯一关注的那样，我现在没有尽可能多的用户知道这是因为无论谁拥有所有的用户，品牌都会喜欢上它。那是正确的。所以就像你刚刚解决了供应方面的问题一样。是然后你就可以担心需求了。是的，很明显，这似乎是一种很好的洞察力。嗯因此，我想要思考的是，目前增长的机制是什么。比如人们是怎么听说你的应用程序的，就像下载一样。很明显，他们只是在卖一些Facebook之类的东西。有成本效益的收购者吗。

\[00:21:22\] Yeah for a while we have been paying like that but that is
just amazing.
...
[00：21：27]那种形式没有道理。Temme用户花一美元是因为不是所有的10个用户最终都呆在这里。嗯嗯它大概是效率的三分之一。是从长远来看，这并不是真正的规模，因为如果你把它等同于我们花在那些有限用户身上的印刷美元，你就会浪费大量的钱，你希望达到这样的程度，你不需要做广告，但是产品中没有任何东西能让你远离这种有趣的东西。“。因此，在结构上，设置产品以继续亏损，这实际上不适用于这里。
...
[00：22：03]但是，就像塔吉特一样，像水价一样，定价是基于他们目前为店内市场支付的价格。是的，不，我们不像，所以我们和互联网相比，就像互联网一样，广告标准高得多，便宜多了。
...
[00：22：17]我的意思是，我们完全没时间了。是的，很高兴你能买到品牌，我认为这才是合理的。
...
[00：22：22]而我认为最重要的是，你必须弄清楚这个触发器是什么，它能让人们说，哦，当我需要一份购物清单时，我必须弄清楚什么是最优惠的东西，比如我该怎么做。你如何让当前的用户告诉其他人这件事。听起来，你现在应该关注的唯一件事就是有偿收购-就像其他事情一样当我们把Peedee的收购加进去的时候，它就像汽油一样，是的，很棒。其他的东西都没用了，你扔得像水一样。是的，我们确实有机增长。太棒了。谢谢。谢谢。非常感谢实用API。
...
我们解决了新能源公司的数据问题。因此，我们与公用事业和太阳能公司合作，自动下载比尔的历史记录，我们降低了客户获取和客户管理的成本。这是未售出的区域。
...
[00：23：35]那么你们是如何降低客户购买成本的呢？在此之前，我是一家太阳能公司的项目经理，每当你到客户面前说“嘿，你想买太阳能”的时候，你必须做的第一件事就是要做的第一件事。你问他们的历史，这是一个非常痛苦和费时的过程，试图找出。
...
[00：23：51]所以你的顾客是那些为家里的人提供太阳能电池板的人，或者你有什么东西的人。是的，现在不是消费者。

\[00:23:57\] I\'ve been B2B SAS. Okay. Well with you guys like the other
office hours we sent it to different we\'re gonna do something different
we need to do a UI review of your site right.

[00：23：57]我一直在B2B SAS。好吧，和你们一样，我们把它发送到不同的办公时间，我们会做一些不同的事情，我们需要对你的网站进行UI审查。

\[00:24:09\] Man there\'s no turning back. All right.

[00：24：09]那里的人没有回头路了，好吧。
...
[00：24：15]好的。我们到了。这已经是前途未卜了。我怎么回过头来。哦，没有红色的按钮，只有一个。好吧太棒了。所以这是实用程序，很抱歉，如果他们要回去看看的话。看看这附近。实际上是出来开始的。所以实用API。这是.这是网络。所以我们只需要浏览产品和登陆页面，我们就会看到产品，而Kevin会得到反馈。所以这是我们在办公时间经常做的事情。就像我说的，这是非常技术性的。
...
[00：24：44]所以让我们开始吧。所以，首先这是实用程序。如果你看这个标语，下载实用程序的构建和使用数据与你的介绍是非常有意义的。

\[00:24:56\] Right. And I\'m your customer or anything that is not
listed on there.

[00：24：56]对。我是你的客户或者其他没有列在上面的东西。
...
[00：25：00]所以我想，是的，我们第一件事是看这个，我真的需要非常坦率地说，我完成了整个产品。一切都会过去的。我终于弄明白你们到底做了什么。这可能不是件好事。
...
[00：25：12]第一件事是，当人们来到网站上时，他们需要问的所有问题都是为了弄清楚我会住在哪里。所以这就像什么是我想要的一样。对我来说是对的吗？我在哪里能得到帮助？它值多少钱？捕获的东西是什么？所以所有的答案都必须得到某种程度的回答。
...
[00：25：26]所以它们就像一条很好的经验法则，因为当你在几毫秒内登陆这个网站时，你会很清楚地理解作为网站的用户，它是为我服务的，还是作为一个网站，这个产品将提供什么。这是你在这两种情况下都错过的。
...
[00：25：41]但是我要说，你有一个伟大的名字是正确的。因为就像我的假设是你们最后描述的一样。但就像我说的，我去了网站，好像我想错了，是的。我们走吧。所以向下滚动看下一张幻灯片。
...
[00：26：00]我们到了。什么是实用程序。这里有一堵墙的文字和一些普通的图片，所以我首先要对你说的是，我没有读过这些。
...
[00：26：13]我知道我在做这篇评论，但它仍然不足以让我真正读到其他人的东西。5秒让我们去做下一件事吧。
...
[00：26：22]所以我的意思是你得一遍又一遍的去做。比如什么。人们想知道什么。我认为现在是一个实用程序API，很明显，它是一个API，您可以访问人们的公用设施账单。想要进入这个世界的人。哦，可能是太阳能公司或想要利用现代技术建设电网的人。右（边），正确的所以我们所做的就是抽象化所有的方式-获取账单数据的认证，基本上变成了一个混蛋的查询。

\[00:26:48\] Right. And in that short sentence it helped me out but that
doesn\'t have any of that there.

[00：26：48]对。在这短短的句子里，它帮了我的忙，但这一点都没有。
...
[00：26：53]另一个我的意思是，我认为一个好的经验法则，一个好的经验法则。对不起。是的，我会这样做，跑一千七百人-这比在房间里要容易得多。
...
[00：27：03]另一件事是，当你构建登陆页面时，你知道一个很好的经验法则，那就是当你被诱惑像悬崖一样放置的时候。它可能不需要在那里。这就像剪贴画一样，几乎从来没有提供过任何类型的信息，这对于那几毫秒的滚动是有价值的。所以我不知道。两个蓝色的剪影握着手，我不知道那是什么意思。好的继续。这是我第一次了解你们到底做了什么-这些都是实际的用例。但问题是，我点击了与使用欧元相关的用例。它并没有说明到底是谁的案件出现在标题中。所以，你知道，这是一个更多的处理，我们不打算复制细节在这里。有些拷贝实际上可以使用像这样的工作，也许头不应该被分发太阳能工具，而你渔民们实际上是使用该产品的客户，因为这样我就可以快速地，我是其中一个人，我是一辆SUV。
...
你知道我是一家公用事业公司的项目经理。我能看到这个。因此，您实际上是将那些实际上是用例一部分的人放在一起，因为您将更快地获得该传输信息。最后，继续下去，这可能是页面中最令人困惑的部分。只是在回顾了几次之后，我才意识到这些实际上不是相互比较的。一次收费是五十美元，另一次是每月五美元，因为我一直认为定价上有数量级的差别，所以我肯定漏掉了像这样的东西。清单上只有一个不同之处，那就是第一次检查。
...
[00：28：39]对。所以花了很长时间才弄明白。就像你说的，你说的是不同之处，就像你如何使用它，它是如何不同的。右（边），正确的但你真正需要做的是告诉我为什么这对我来说是合适的。右（边），正确的所以这就像你需要一次从你的客户那里获取所有的账单数据吗？右（边），正确的这是你需要的。哦，您需要连续访问您的客户数据吗？这是你需要的。
...
[00：29：12]这是给我的吗？我所选择的选择之一。你这样说，这就像一个或另一个的比较。另外，不要喜欢推断出与Xs一致的信息，而不是完全相同的信息。
...
[00：29：23]你知道我的直觉告诉我，我要做的就是说，嘿，我们提供两种不同的产品。每一家公司都可能只能使用一种需求，或者两者都使用过。

\[00:29:34\] OK. So continuing on. Further down the page.

[00：29：34]好的。所以还在继续。再往下看。

\[00:29:38\] Oh I love it. He\'s being smart.

[00：29：38]哦，我爱死它了。他很聪明。
...
[00：30：08]是的。占所有电力的百分之十和美国酷世界的百分之十。
...
[00：30：19]我要再次重申这种严厉。我们并不是说这引起了很大的反馈，谢谢。现在让我们跳进产品本身吧。

\[00:30:28\] You sent me a. You sent me a code. I put it in. And this is
what I land into.

[00：30：28]你给我发了一封信。你给我发了密码。我把它放进去了。这就是我着陆的原因。
...
[00：30：34]这是你有一个问题要问你。您希望人们在此页面上做的最重要的事情是什么，单击“添加新”。
...
[00：30：41]哦。我知道那里最微小的联系。所以我回到你的电子邮件里，因为我不知道这可能是整个产品，我只是在看它，然后你有一个简单的12步过程，通过演示你的产品。所以。
...
[00：31：12]这就是我们的朋友们所设计的智慧。右（边），正确的这个东西看起来像一个按钮，它实际上激活了页面，我的服务是正确的，如果我点击这个按钮，它只会刷新页面。嗯然后添加新的当然。你知道两个最小的链接。是这就像他们，我的建议是你刚刚开始添加新的。嗯你知道他们没有。你就直接跳进去吧。
...
[00：31：35]凯文处理这件事的方式，他真的认为这些都是标签。所以他说，哦，等等，这就像我的，真的，我们真的迷路了。所以无论如何，我们实际上点击Add New，我只是放大了一下，如果你们能看到这个值，这可能是它应该有多大。

\[00:31:53\] Well it\'s fairly massive do it. Laughter.

[00：31：53]嗯，它相当大，那么就去做吧。笑声。
...
[00：31：58]最后，我点击“添加新火”，点击这里的点击器有点滞后，我被发送到这里很好，因为它非常清楚地告诉我，有几个步骤我必须做。我点击掉的步骤，实际上点击演示，就像你在电子邮件中告诉我的那样。

\[00:32:16\] And what you guys might have not noticed when I clicked on
...
[00：32：16]当我点击演示时，你们可能没有注意到，第三步出现在下面，但它在页面折叠下面，所以我不知道，直到我重新尝试它。这些都是这样的东西，一般的，这里的外卖，在你们面前的现实生活中发生了什么，我们就像使用这个的用户，他们不知道产品是什么。很多时候，当创始人设计他们的产品时，他们使用的是他们已经意识到的一些条款和互动，所以他们会想，哦，当然，你知道，很明显，有人会选择你将要成为的公用事业公司和你所知道的公司。
...
[00：32：53]是的。所以在这一点上，我几乎就像是在等待，这是为了更多的消费者，或者你喜欢什么。我没有意识到这是一个演示，这是你作为一个开发人员可以避免的，只是没有什么是明确的。
...
[00：33：03]此时，您可能会认为这是我们将开发的API。文档在哪里，为什么文档被记录下来，因为它不在主页上。
...
[00：33：10]我觉得对于每一家API公司来说，最需要理解的是，作为一个API，接口是文档对的。这是你需要让人们最兴奋的事情，实际上是在我们读博士的时候。这些都很棒。
...
[00：33：51]是的。即使你表现出色，比如说你在付费或者其他应用程序中，也不能以此为借口不显示你网站上的应用屏幕截图，比如人们是如何购买这样的服务的。
...
[00：34：00]，我需要解决一个问题，在底层的某个开发人员中，我需要解决一个问题。搜索就像庞培的任何东西一样，就像你的文档会有丰富的东西一样，这些东西是很容易找到的。但你也可以快速搜索，看看你说的OK。你知道我觉得这是我需要的。现在我要进去报名了，并且愿意经历所有的麻烦。找出所有这些东西，因为像这样的界面，直到我读到文档，我才意识到这是一个正确的例子。这是一个如何使用他们的API并连接到所有这些东西的例子。这是一个例子，开发人员可以构建正确的，所以在右上角。
...
[00：34：32\]页面您可以下载此特定页面的Jason格式，如果您更改DOT JasonIt将是该页面的Jason实现，则可以在老版Hammell上下载。

\[00:34:42\] So not now brought in an example here a demo example What
...
[00：34：42]所以现在不要引入一个示例，一个演示示例，我应该按什么，我应该按一下“激活正确”。幸运的是，这是我唯一看到的按钮，所以我点击了它，然后它带来了本质上是假的数据，它说，13账单在96个时间间隔，然后我真的不知道做什么，我点击了PTF，实际上看到了哦，有一个演示钟，这也是你真正想让用户使用它。我认为这里的关键是工作流程。你知道，只有花很长的时间才能看到用户会花十分之一的努力去理解它。没错。最后一件事是实际的文档做得很好。所以，或者说，就像我想的那样，我会尽一切努力，你不能把它放在前面和中间，把它作为你的卖点。

\[00:35:32\] We\'re out of time. That\'s how we get.

[00：35：32]我们没时间了，我们就是这样得到的。
